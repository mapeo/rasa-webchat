  ...
  return (
    userInput === 'hide' ? <div /> : (
      <form ref={formRef} className="rw-sender" onSubmit={handleSubmit}>
        <TextareaAutosize maxRows='1' value={inputValue === ''?inputTextFieldHint:<></>} onChange={handleChange} onKeyDown={onEnterPress} className="rw-new-message" name="message" placeholder={inputTextFieldHint} disabled={disabledInput || userInput === 'disable'} autoFocus autoComplete="off"></TextareaAutosize>
